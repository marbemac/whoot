    ...
    if target_post
      ...
      if target_post.save
        ...
        if target_user.device_token
          Notification.send_push_notification(target_user.device_token, target_user.device_type, "#{current_user.fullname} looped into your night.", target_user.unread_notification_count)
        end
      end
